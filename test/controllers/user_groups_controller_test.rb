...
class UserGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_group" do
    assert_difference('UserGroup.count') do
      post user_groups_url, params: { user_group: { group_id: @user_group.group_id, image_url: @user_group.image_url, name: @user_group.name, user_id: @user_group.user_id } }
    end
  ...
  test "should update user_group" do
    patch user_group_url(@user_group), params: { user_group: { group_id: @user_group.group_id, image_url: @user_group.image_url, name: @user_group.name, user_id: @user_group.user_id } }
